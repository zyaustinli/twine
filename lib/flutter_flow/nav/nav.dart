      ...
      routes: [
        ...
        */
        FFRoute(
          name: 'foryou',
          path: '/foryou',
          builder: (context, params) => const ForyouWidget(),
        ),
        FFRoute(
          name: 'collection_view',
          path: '/collectionView',
          builder: (context, params) => const CollectionViewWidget(),
        ),
        FFRoute(
          name: 'collection_create',
          path: '/collectionCreate',
          builder: (context, params) => const CollectionCreateWidget(),
        ),
        FFRoute(
          name: 'chat',
          path: '/chat',
        ...
        FFRoute(
          name: 'create_outfit',
          path: '/createOutfit',
          builder: (context, params) => const CreateOutfitWidget(),
        ),
        FFRoute(
          name: 'inbox',
          path: '/inbox',
