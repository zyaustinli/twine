...
class _SingleviewWidgetState extends State<SingleviewWidget> {
  late SingleviewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SingleviewModel());
  }
